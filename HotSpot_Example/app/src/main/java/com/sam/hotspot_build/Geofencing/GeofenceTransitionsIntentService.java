...
public class GeofenceTransitionsIntentService extends IntentService {
    ...
    public void onCreate() {
        super.onCreate();
        Log.i("Reached Intent Creator", "Intent creator onCreate!");
    }

    @Override
    protected void onHandleIntent(Intent intent) {
        Log.i("onHandle", "HANDLED");
    ...
    private String getTransitionString(int transitionType) {
        switch (transitionType) {
            case Geofence.GEOFENCE_TRANSITION_ENTER:
                Log.i("Entering", "Entering transition handled");
                return getString(R.string.geofence_transition_entered);
            case Geofence.GEOFENCE_TRANSITION_DWELL:
                Log.i("Dwelling", "Dwelling transition handled");
                return getString(R.string.geofence_transition_dwell);
            case Geofence.GEOFENCE_TRANSITION_EXIT:
                Log.i("Exiting", "Exiting transition handled");
